...
/**
 * https://github.com/EnMasseProject/enmasse/blob/1d72047dd5ea19dc37dee688d7877df19f1b8639/broker-plugin/sasl-delegation/src/main/java/io/enmasse/artemis/sasl_delegation/SaslGroupBasedSecuritySettingsPlugin.java
 * **/
@SuppressWarnings("serial")
public class ArtemisSaslGroupBasedSecuritySettingsPlugin implements SecuritySettingPlugin {

    private static final Logger LOG = Logger.getLogger(ArtemisSaslGroupBasedSecuritySettingsPlugin.class);

    private static final Map<String, ArtemisSaslGroupBasedSecuritySettingsPlugin> INSTANCES = new ConcurrentHashMap<>();
    ...
    static ArtemisSaslGroupBasedSecuritySettingsPlugin getInstance(String name) {
